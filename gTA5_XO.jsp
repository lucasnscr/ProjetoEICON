                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="product-images">
                                        <div class="product-main-img">
                                            <img src="http://www.jonygames.com.br/media/catalog/product/g/t/gta_v_xbox_one_capa_jony_games.jpg" alt="" style="
                                                 width: 300px;
                                                 height: 360px;
                                                 ">
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="product-inner">
                                        <h2 class="product-name"><%=java.util.ResourceBundle.getBundle("Strings/newproperties").getString("GTA")%></h2>
